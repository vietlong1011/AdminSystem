...
nohup java -Duser.timezone=Asia/Ho_Chi_Minh -Dthin.root=/opt/tmss/ -Dthin.location=./config -jar tmss-gateway-0.0.1-SNAPSHOT.jar  --spring.profiles.active=gitlabci &
sleep 2
