...
#nohup java -Duser.timezone=Asia/Ho_Chi_Minh -jar -Dspring.config.location=/opt/release/sale/application-gitlabci.properties,classpath:/application.properties tmss-api-0.0.1-SNAPSHOT.jar &
#sleep 2
...
#nohup java -Duser.timezone=Asia/Ho_Chi_Minh -Dthin.root=/opt/tmss/ -Dthin.location=./config -jar tmss-services-api-0.0.1-SNAPSHOT.jar  --spring.profiles.active=gitlabci &
nohup java -Duser.timezone=Asia/Ho_Chi_Minh -Dthin.root=/opt/tmss/lib/ -Dthin.offline=true -Dthin.location=file:./config -jar tmss-services-api-0.0.1-SNAPSHOT.jar --spring.profiles.active=gitlabci &
